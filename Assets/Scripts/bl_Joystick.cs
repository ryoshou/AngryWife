...
public class bl_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    [Header("Settings")]
    [SerializeField, Range(0, 15)]public float Radio = 5;//the ratio of the circumference of the joystick
    [SerializeField, Range(0.01f, 1)]public float SmoothTime = 0.5f;//return to default position speed
    [SerializeField, Range(0.5f, 4)] public float OnPressScale = 1.5f;//return to default position speed
    public Color NormalColor = new Color(1, 1, 1, 1);
    public Color PressColor = new Color(1, 1, 1, 1);
    [SerializeField, Range(0.1f, 5)]public float Duration = 1;
    ...
    /// </summary>
    /// <returns></returns>
    public IEnumerator ScaleJoysctick(bool increase)
    {
        float _time = 0;
    ...
    public float smoothTime { get { return (1 - (SmoothTime)); } }
